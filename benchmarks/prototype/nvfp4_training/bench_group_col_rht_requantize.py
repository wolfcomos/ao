...
"""Benchmark the grouped rotated columnwise weight requantize across backends (triton, cutedsl).
...
def make_runner(
    ...
    if backend == "triton":
        ...
        from torchao.prototype.moe_training.nvfp4_training.group_col_rht_requantize_triton import (
            triton_group_col_rht_requantize as op,
        )
...
def run_experiment(config: ExperimentConfig) -> Optional[ExperimentResult]:
    ...
    if cutedsl_nvfp4_kernels_available():
        ...
        from torchao.prototype.moe_training.nvfp4_training.group_col_rht_requantize_triton import (
            triton_group_col_rht_requant_amax as amax_op,
        )
