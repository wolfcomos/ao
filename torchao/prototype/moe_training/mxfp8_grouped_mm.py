...
def _backward_override_grads_tuple(
    ...
    return (grad_input, grad_weight_t) + (None,) * 7
...
def _compute_wgrad_sm100(
    ...
    # Use Triton kernel for dim1 quant; it asserts contiguity, and expanded
    # or transposed gradient views would otherwise crash it.
    grad_output = grad_output.contiguous()
    ...
    grad_output_t_mx = _to_mxfp8_dim1_kernel_wrapper(
        ...
        cast_kernel_choice=MXFP8Dim1CastKernelChoice.TRITON,
